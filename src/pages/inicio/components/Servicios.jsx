    ...
    <Div className=" max-w-screen-xl mx-auto bg-white rounded-2xl">
      <div className="cards mx-auto max-w-screen-xl mt-4">
        <Ul className="list-cards">
          <li className="">
            <a  className={activeItem==='Diseño'?"active":""} onClick={()=>handleItemClick('Diseño')} > <svg
          ...
          <li>
            <a  className={activeItem==='Supervición'?"active":""} onClick={()=>handleItemClick('Supervición')}><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth={1.5}
          ...
          <li>
            <a className={activeItem==='Gestión'?"active":""} onClick={()=>handleItemClick('Gestión')}> <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth={1.5}
