...
export  default function RomuloModal() {
  ...
  return (
    <>
      ...
      >
        <span className="flex justify-center items-center" > <p className="mr-1">Mas</p>   <ion-icon name="open-sharp"></ion-icon></span>
      </button>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-end gap-2 w-full">
                  <button  onClick={() => setIsShowing(false)} className="inline-flex h-10 items-center right-0 justify-center gap-2 whitespace-nowrap rounded bg-blue-500 px-5 text-sm font-medium tracking-wide text-white transition duration-300 hover:bg-blue-600 focus:bg-blue-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-blue-300 disabled:bg-blue-300 disabled:shadow-none">
                    <span>Cerrar</span>
                  </button>
